...
onMounted(() => {
  ...
  gradientStroke1.addColorStop(0.5, "rgba(244,178,37,0.5)");
  gradientStroke1.addColorStop(0.2, "rgba(248,228,139,0.5)");
  gradientStroke1.addColorStop(0, "rgba(255,255,255,1)"); //purple colors
